    ...
    $scope.changeArray = function(param) {
        if (param == 'ElderScrolls') {
            if ($scope.elder) {
			   ...
			   $scope.currentQuotes = $scope.currentQuotes.filter(function(a){return a.type !== 'Elder'});
			   $scope.filters--;
            ...
            if ($scope.civ) {
                // Remove all matching quotes from currentArray.
				$scope.currentQuotes = $scope.currentQuotes.filter(function(a){return a.type !== 'Civ'});
				$scope.filters--;
            ...
            if ($scope.disc) {
                // Remove all matching quotes from currentArray.
				$scope.currentQuotes = $scope.currentQuotes.filter(function(a){return a.type !== 'Disc'});
				$scope.filters--;
            ...
            if ($scope.darkest) {
                // Remove all matching quotes from currentArray.
				$scope.currentQuotes = $scope.currentQuotes.filter(function(a){return a.type !== 'Darkest'});
				$scope.filters--;
            ...
            if ($scope.misc) {
                // Remove all matching quotes from currentArray.
				$scope.currentQuotes = $scope.currentQuotes.filter(function(a){return a.type !== 'Misc'});
				$scope.filters--;
